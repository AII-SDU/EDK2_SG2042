  ...
  )
{
  ...
  Addr = (UINT64)FixedPcdGet32(PcdVariableFirmwareRegionBaseAddress);
  Size = FixedPcdGet32(PcdVariableFirmwareRegionSize);

  DEBUG ((
    DEBUG_INFO,
    "%a: Adding RuntimeServices Memory Addr = 0x%llx, Size = 0x%llx\n",
    __func__,
    Addr,
    Size
  ));
